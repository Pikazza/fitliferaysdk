...
<% 
String articleidbackground = PortletProps.get("calculator.background.shorttermloan.content");
                            ...
                            <div id="quickQuote" class="row-blk"> 
                                <aside class="grid-5 calcResults eqc tabAside fR">
                                                ...
                                                <div class="white-patch-mobile white-patch-tab-1"> 
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" width="40%"><div id="monthly_payment">&pound;<span>0</span></div></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Total repayable</td>
                                                            <td align="right"><div id="total_payable">&pound;<span>0</span></div></td>
                                                        </tr>
                                                    </table>
                                                </div>    
                                            </div>
                                    ...
                                    <div class="button-row">
                                       <button  id="apply" class="button cal-button" disabled="disabled">Apply Now</button>
                                    </div>   
                                </aside>    
                        ...
                        <div class="loanContent">
                            <div id="quickQuote1" class="row-blk">
                                <aside class="grid-5 calcResults eqc tabAside fR">
                                        ...
                                        <div id="glance-table">
                                            <div class="glance-visible-area">
                                                ...
                                                <table width="100%">
                                                        ...
                                                        <tr>
                                                            <td>Total repayable</td>
                                                            <td align="right"><div id="total_payable1">&pound;<span>900.00</span></div></td>
                                                        </tr>
                                                    </table>                                     
                                                </div>                                     
                                            </div>
                                    ...
                                    <div class="button-row">
                                        <button id="applytab2" class="button">Apply Now</button>
                                    </div>
                                </aside>                        
