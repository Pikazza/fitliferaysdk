...
<% 
String articleidbackground = PortletProps.get("calculator.background.content");
...
/*   console.log("arr2"+arr2);
  console.log("montlyrepayment "+monRepayment);
  console.log("totalrepayment"+totRepayment); */
});
