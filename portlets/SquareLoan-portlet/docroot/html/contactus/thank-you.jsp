    ...
    <section class="thank-you-wapper">
        <div class="container">
            <div class="row-blk">
                <div class="grid-10">
                    <h1>Thank you</h1>
                    <p>We have received just request. We have also send a copy to your email ID for future reference</p>
                </div>
            </div>
        </div>
    </section>
    <!-- get social start-->
    <section class="section get-social text-center">
        <div class="container">
            <h3>Get Social</h3>
            <ul>
