...
<portlet:actionURL var="addFuel" >
<portlet:param name="action" value="addFuel"/>
</portlet:actionURL>
              ...
              <div class="sub-division">
                <div class="formRow">
                  <div class="formInnerField">
                    ...
                    <input type="text" name="resName" value="${resName}" class="tetxBox" placeholder="">
                  </div>
                </div>   
                 <div class="formRow">
                  <div class="formInnerField">
                     <label data-error="Please enter restaurant type"><span>Restaurant Type</span></label>
                    <input type="text" name="resType" value="${resType}" class="tetxBox" placeholder="">
                  </div>
                </div>
                ...
                <div class="formRow">
                  <div class="formInnerField">
                     <label data-error="Please enter restaurant latitude"><span>Latitude</span></label>
                    <input type="text" name="resLat" value="${resLat}" class="tetxBox" placeholder="">
                  </div>
                </div>
                <div class="formRow">
                  <div class="formInnerField">
                      <label data-error="Please enter restaurant longitude"><span>Longitude</span></label>
                    <input type="text" name="resLong" value="${resLong}" class="tetxBox"  placeholder="">
                  </div>
                </div>   
                </div>
              <div class="sub-division">
                ...
                <div class="formRow">
                  <div class="formInnerField">
                      <label data-error="Please select the restaurant status"><span>Restaurant Status</span></label>
                      <select name="resStatus" class="selectMenu">
